...
<div class="panel panel-headline" id="app-team">
    <div class="panel-heading">
        <h3 class="panel-title pull-left">Manage Training Provider Page Slider</h3>
        <a id="btnModal" href="javascript:void(0);" class="btn btn-primary pull-right"><i class="fa fa-plus">&nbsp;</i> Add New Training Slider</a>
        <div class="clearfix"></div>
        <p class="panel-subtitle">This is your training slider page dashboard</p>
    </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url()?>administrator/apis/deleteSlider/training-provider/<?php echo $item['images_id']?>" onclick="return confirm('Are you sure to delete <?php echo $item['images_name']?> ?')"><span class="label label-danger">Delete</span></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" enctype="multipart/form-data">
                    <input class="form-control" type="hidden" name="images_category" data-validate="images_category" value="4" readonly>
...
<script>
    $(function() {
        $('#btnModal').click(function() {
            $('#addModal').modal('show');
            $('#addModal').find('.modal-title').text('Add New Training Slider');
            $('#addModal').find('#addBtn').text('Add New Slider');
            $('#addForm').attr('action', '<?php echo base_url()?>administrator/apis/addSliderAll/training-provider');
